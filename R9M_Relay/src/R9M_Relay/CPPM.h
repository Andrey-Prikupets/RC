/*	CPPM - Combined PPM
	...
	The width of synch pulse is 305us + an undefined extra time, but no more than 20us (as experimented).

	NOTE: For FrSky X4R RX it is up to 400us.
...
// AP; 88 replaced to 120; // #define CPPM_PULSE_SYNC_MAX_CEIL CPPM_T_ceil(312 + 88) //(FRSKY_PULSE_SYNC + 100) //50) // check sync width... (FRSKY_PULSE_SYNC+20) is too short with R615X
#define CPPM_PULSE_SYNC_MAX_CEIL CPPM_T_ceil(500) // FrSky X4R emits 400us sync value; 
...
// AP; X4R sends gap between servo frames 4390us longer (26930us) // #define CPPM_FRAME_NOTSYNC_CEIL CPPM_T_ceil(22765 + 135) //(R615X_FRAME_NOTSYNC + 100) // 2% max oscillator error
#define CPPM_FRAME_NOTSYNC_CEIL CPPM_T_ceil(22765 + 135+4600) //(R615X_FRAME_NOTSYNC + 100) // 2% max oscillator error
...
// CPPM fail reasons;
#define CPPM_NO_FAIL 0
#define CPPM_FAIL_SYNC_PULSE_MIN 1
#define CPPM_FAIL_SYNC_PULSE_MAX 2
#define CPPM_FAIL_SERVO_PULSE_MIN 3
#define CPPM_FAIL_FRAME_TOO_LONG 4
#define CPPM_FAIL_SERVOS_NUM_MAX 5
#define CPPM_FAIL_SERVOS_NUM_FOUND 6
#define CPPM_FAIL_FRAME_TOO_SHORT 7
#define CPPM_FAIL_T_CHECK 8
